...
<head>
    ...
    <link href="{{ asset('assets/front-face/vendor/jqvmap/dist/jqvmap.css') }}" media="screen" rel="stylesheet"
          type="text/css">
    @yield('styles')
</head>
<body>
...
@include('front.main.navbar')
@yield('content')
@include('front.partials.footer')
<script type="text/javascript" src="{{ asset('assets/front-face/vendor/jqvmap/dist/jquery.vmap.js') }}"></script>
<script type="text/javascript" src="{{ asset('assets/front-face/vendor/jqvmap/dist/maps/jquery.vmap.world.js') }}"
